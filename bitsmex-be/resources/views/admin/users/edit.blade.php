					...
					<div class="row">
						<div class="col-md-6">
							<table class="admin_table">
								...
								<tr>
									<th>Email</th>
									<td>
									<input type="text" disabled name="email" class="form-control" value="{{ !is_null($user->email) ? $user->email : old('email') }}" placeholder="Email" required value="{{ $user->email }}">
									</td>
								</tr>
								<tr>
									<th>Phone number</th>
						...
						<div class="col-md-6">
							<table class="admin_table">
                                <tr>
                                    ...
                                    <td>
                                        <div class="switch_toggle">
											<input type="radio" name="kyc_status" class="switch_on" content="Verified" value="2"{{ $user->kyc_status == 2 ? ' checked' : '' }}>
								...
								@if($user->admin_setup == 0)
								<tr>
                                    <th>Active Franchise</th>
                                    <td>
                                        <div class="switch_toggle">
											<input type="radio" name="is_franchise" class="switch_on" content="On" value="1"{{ $user->is_franchise == 1 ? ' checked' : '' }}>
											<input type="radio" name="is_franchise" class="switch_off" content="Off" value="0"{{ $user->is_franchise == 0 ? ' checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
								@endif
								...
								<tr>
                                    ...
                                    <td>
                                        <div class="switch_toggle">
											<input type="radio" name="level" class="switch_on" content="On" value="1"{{ $user->level ? ' checked' : '' }}>
											<input type="radio" name="level" class="switch_off" content="Off" value="0"{{ !$user->level ? ' checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
								@endif --}}
								<tr>
                                    ...
                                    <td>
                                        <div class="switch_toggle">
											<input type="radio" name="admin_setup" disabled class="switch_on" content="On" value="1"{{ $user->admin_setup == 1 ? ' checked' : '' }}>
											<input type="radio" name="admin_setup" disabled class="switch_off" content="Off" value="0"{{ $user->admin_setup == 0 ? ' checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
								@if($user->admin_setup)
								<tr>
                                    <th>Live balance</th>
                                    <td class="d-flex">
										<input type="text" name="live_balance" class="form-control" value="{{ $user->live_balance }}" placeholder="Live Balance">
									</td>
                                </tr>
								@endif
                                {{-- <tr>
