                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="level_name" class="form-control w-100"
                                            placeholder="Nhập username hoặc email" required value="{{ $commissionlevel->level_name }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>Level</th>
                                    <td>
                                        <input type="text" name="level_number" class="form-control w-100"
                                            placeholder="Nhập username hoặc email" required value="{{ $commissionlevel->level_number }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>Phần trăm</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="f1_count" class="form-control w-100"
                                            ...
                                            value="{{ $commissionlevel->f1_count }}">
                                    ...
                                    <td>
                                        <input type="text" name="personal_volume" class="form-control w-100"
                                            ...
                                            value="{{ $commissionlevel->personal_volume }}">
                                    ...
                                    <td>
                                        <input type="text" name="f1_volume" class="form-control w-100"
                                            ...
                                            value="{{ $commissionlevel->f1_volume }}">
								...
								<tr>
                                    ...
                                    <td>
                                        <div class="switch_toggle">
											<input type="radio" name="actived" class="switch_on" content="Actived" value="1"{{ $commissionlevel->actived == 1 ? ' checked' : '' }}>
											<input type="radio" name="actived" class="switch_off" content="Inactive" value="0"{{ $commissionlevel->actived == 0 ? ' checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
