...
<div class="content_wrapper">
	<div class="page_title">
		...
		<a class="button_title" href="{{ route('admin.policy.commissionsale.add') }}">Thêm</a>
	</div>
		...
		<div class="datatable">
			...
			<div class="table-responsive-sm">
				<table class="table table-bordered">
					...
					<tbody>
						@include('admin.policy.commissionsale._item')
					</tbody>
				</table>
			</div>
			<div class="table_bottom_actions">
				...
				<div class="table_bottom_actions_right">
					<div class="table_items">{!! 'Show ' . $commissionsale->count() . ' of ' . $commissionsale->total() . ' items' !!}</div>
				</div>
				<div class="table_paginate">
					{!! $commissionsale->links() !!}
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
...
<script type="text/javascript">
	table_search($('.table_search_submit'), "{{ route('admin.policy.commissionsale.search') }}");
</script>
@endpush
