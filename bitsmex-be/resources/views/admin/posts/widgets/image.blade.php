	...
	<div class="x_content">
		<div class="choose_img_lib post_single_image">
						...
						<div class="img_thumbnail">
							<div class="img_centered">
								<img class="show_img_lib"
									src="{{ isset($post->post_img) ? $post->post_img : url('/contents/images/defaults/no-image.jpg') }}"
									alt="Featured Image">
							</div>
						</div>
			...
			<input type="hidden" class="fill_img_lib" name="post_img"
				value="{{ isset($post->post_img) ? $post->post_img : asset('contents/images/defaults/no-image.jpg') }}">
		</div>
	</div>
</div>