jQuery(document).ready(function($) {
	...
	$('.collapse .sub-menu>li>a').each(function(index, el) {
		if($(this).attr('href') == active_url){
			$(this).closest('.admin_nav_li').addClass('active');
			$(this).closest('.admin_nav_li').children('.nav-link').attr('aria-expanded', 'true');
